...
public class TestExecute {
	...
	public static void getAnnotationMessage() {
	...
	/**
	 * @Description 这些元数据，在框架设计时候很多时候我们都希望从File(Resource)里得到，
	 * 而不是从Class文件里获取，所以就是MetadataReader和MetadataReaderFactory。
	 * @Author hanyf
	 * @Date 10:15 2020/4/16
	 * @Param
	 * @return void
	 **/
	public static void getMetaByFactory() throws IOException {
		CachingMetadataReaderFactory readerFactory = new CachingMetadataReaderFactory();
		// 下面两种初始化方式都可，效果一样
		// MetadataReader metadataReader = readerFactory.getMetadataReader(MetaDemo.class.getName());
		org.springframework.core.type.classreading.MetadataReader metadataReader = readerFactory.getMetadataReader(new ClassPathResource("com/yestae/gateway/test/MetaDemo.class"));

		ClassMetadata classMetadata = metadataReader.getClassMetadata();
		AnnotationMetadata annotationMetadata = metadataReader.getAnnotationMetadata();
		org.springframework.core.io.Resource resource = metadataReader.getResource();
