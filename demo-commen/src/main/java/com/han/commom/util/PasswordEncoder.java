...
public class PasswordEncoder {
	...
	@Autowired
	public PasswordEncoder(@Value("${user.password.salt:yestae}") Object salt, @Value("${user.password.algorithm:MD5}") String algorithm) {
		this.salt = salt;
		this.algorithm = algorithm;
	}

	public PasswordEncoder(@Value("${user.password.salt:yestae}") Object salt) {
		this.salt = salt;
	}
